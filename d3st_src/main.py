...
def main(args):
    ...
    if args.do_test or args.do_predict or args.do_predict_cooking:
        dm = DataModule(**dict_args)
        if args.do_test:
            stage = 'test'
...
if __name__ == '__main__':
    ...
    parser.add_argument("--do_predict_cooking", action="store_true", help="Whether to run eval on the cooking predict "
                                                                          "set.")
    ...
    parser.add_argument("--strategy", default="ddp", type=str, help="Training strategy")
