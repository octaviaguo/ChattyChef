...
class Cooking(datasets.GeneratorBasedBuilder):
            ...
            features=datasets.Features(
                {
                    ...
                    "Completed_step": datasets.Value("string")
                }
            ),
            homepage=_WEBPAGE,
            citation=_CITATION,
    ...
    def _split_generators(self, dl_manager):
        ...
        train_path = '../data/cookdial_v2/cooking_train.jsonl'
        validation_path = '../data/cookdial_v2/cooking_valid.jsonl'
        test_path = '../data/cookdial_v2/cooking_test.jsonl'
